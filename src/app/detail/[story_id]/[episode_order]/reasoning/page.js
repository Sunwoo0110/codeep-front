...
export default function Reasoning() {
    ...
    const updateStat = async () => {
        ...
        const res = await axios.post(`http://ec2-54-180-131-231.ap-northeast-2.compute.amazonaws.com/stats/update_stat`, {
            story_id: storyId,
            name: userName,
            level: level,
            is_arrest: is_arrest
    ...
    const getPoint = async (input) => { 
        ...
        const res = await axios.post(`http://ec2-54-180-131-231.ap-northeast-2.compute.amazonaws.com/points/detect_point`, {
            story_id: storyId,
            name: userName,
            level: level,
    ...
    const createChat = async (input, point) => {
        ...
        if (input === "") {
            ...
            const res = await axios.post(`http://ec2-54-180-131-231.ap-northeast-2.compute.amazonaws.com/chattings/create_chat`, {
                story_id: storyId,
                name: userName,
                level: level,
                input: input,
    ...
    useEffect( () => {
        const getChats = async () => {
            const res = await axios.post(`http://ec2-54-180-131-231.ap-northeast-2.compute.amazonaws.com/chattings/get_all_chat`, {
                story_id: storyId,
                name: userName,
                level: level
            });
